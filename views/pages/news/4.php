<div class="row">
  <div class="col-md-12">
    <h3>
      The 2018 SCBA Washington DC-Baltimore Chapter Annual Holiday Party
    </h3>

    <h5>
      Li Yang, President of the SCBA DC-Baltimore Chapter
    </h5>
    <br/>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <br/>
        <p>
          Slides from Dr. Ed Liu's presentation: <br/>
          <a href="https://drive.google.com/file/d/1TnujjhTNg2C6EoUmRwyvjYLEq39kByuG/view?usp=sharing">“From follower to leader: navigating the American science”</a>
        </p>
      </div>
        ...
        <table class="table">
          <tr>
            <figure class="newsFigure">
              <img class="newsImage" src="/public/images/news/4/Group_Photo.jpg">
              <figcaption>2018 Holiday Party group photo.</figcaption>
            </figure>
          </tr>

          <tr>
            <figure class="newsFigure">
              <img class="newsImage" src="/public/images/news/4/Ed_Liu_Talk.jpg">
              <figcaption>Dr. Edison Liu, president and CEO of The Jackson Laboratory, delivered a talk entitled <a href="https://drive.google.com/file/d/1TnujjhTNg2C6EoUmRwyvjYLEq39kByuG/view?usp=sharing">“From follower to leader: navigating the American science”</a>.</figcaption>
            </figure>
          </tr>
          ...
          <tr>
            <td class="col-md-6">
              <figure class="newsFigure">
                <img class="newsImage" src="/public/images/news/4/Ji_Luo_Welcome.jpg">
                <figcaption>Dr. Ji Luo, the chapter President-Elect delivered welcome remarks.</figcaption>
              </figure>
            </td>

            <td class="col-md-6">
              <figure class="newsFigure">
                <img class="newsImage" src="/public/images/news/4/Li_Yang_Activity.jpg">
                <figcaption>Dr. Li Yang, the chapter President, gave the 2018 local chapter annual activity report.</figcaption>
              </figure>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="col-md-6">
              <figure class="newsFigure">
                <img class="newsImage" src="/public/images/news/4/Hong_Sang_Wang_Singing.jpg">
                <figcaption>Hong Sang Wang: 意大利文歌《我亲爱的爸爸》 or 《O Mio Babbino Caro 》 and 哈萨克民歌《燕子.</figcaption>
              </figure>
            </td>
          </tr>
          ...
          <tr>
            <td class="col-md-6">
              <figure class="newsFigure">
                <img class="newsImage" src="/public/images/news/4/Ling_Hao_Singing.jpg">
                <figcaption>Hao Ling: 乎伦贝儿大草原.</figcaption>
              </figure>
            </td>

            <td class="col-md-6">
              <figure class="newsFigure">
                <img class="newsImage" src="/public/images/news/4/Yang_Liu_Election.jpg">
                <figcaption>Dr. Yang Liu was elected as the President –Elect for SCBA DC Baltimore Chapter, will serve in the year 2020.</figcaption>
              </figure>
            </td>
          </tr>
          ...
          <tr>
            <td class="col-md-6">
              <figure class="newsFigure">
                <img class="newsImage" src="/public/images/news/4/Li_Yang_Award.jpg">
                <figcaption>Dr. Ji Luo presented an award to Dr. Li Yang, president of SCBA DC Baltimore Chapter, for her outstanding leadership and service.</figcaption>
              </figure>
            </td>
          </tr>
        </table>
