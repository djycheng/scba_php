<div class="container">
  <img id="header" src="public/images/header.png">
</div>
<h1 style="text-align: center;">Washington D.C./Baltimore Chapter</h1>
    ...
    <div id="carousel" class="carousel slide" data-ride="carousel">
      ...
      <div id="carousel-inner" class="carousel-inner" role="listbox">
        <div class="item active">
          <div id="img1" class="slider-size">
          </div>
        </div>
        <div class="item">
          <div id="img2" class="slider-size">
          </div>
        </div>
        <div class="item">
