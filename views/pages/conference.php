...
<!--     <ul class="list-group">
  ...
  <div class="col-md-6">
    ...
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" id="conference-registration">
      <label for="name">
        Full Name:
      </label>
      ...
      <div class="row" name="abstract" id="abstract">
        ...
        <div class="col-md-2">
          No <input type="radio" name="abstract" value="no" checked="checked"> 
        </div>
      </div>
      <div class="filler"></div>
      <div class="filler"></div>
      ...
      <tr><td><input type="hidden" name="on0" value="Registration Fee" name="Registration Fee"></td></tr><tr><td><select name="os0" id="payment">
        ...
        <option value="Postdoc">Postdoc $100.00 USD</option>
        <option value="Student">Student $50.00 USD</option>
      </select> </td></tr>
      </table>
      <div class="filler"></div>
      <div class="filler"></div>
